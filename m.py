...
bot = telebot.TeleBot('7515339193:AAHq7M4Va5KiqsYEZtzRivaAxiii89iDywA')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @Rohan2349")
...
3. MAKE SURE YOU JOINED  https://t.me/freeddos_group12 OTHERWISE NOT WORK
